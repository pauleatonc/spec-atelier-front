...
export const Input = styled.input`
  ...
  height: 100%;
  letter-spacing: 1px;
  padding: ${({ justifyContent = 'flex-start' }) => justifyContent === 'flex-start' ? '11px 20px 10px 51px' : '11px 20px 10px'};
  width: 100%;
...
export const SearchIcon = styled.img`
  bottom: 0;
  left: ${({ justifyContent = 'flex-start' }) => justifyContent === 'flex-start' ? '20px' : '0'};
  margin: ${({ justifyContent = 'flex-start' }) => justifyContent === 'flex-start' ? 'auto 0' : 'auto 9px auto 0'};
  position: ${({ justifyContent = 'flex-start' }) => justifyContent === 'flex-start' ? 'absolute' : 'relative'};
  top: 0;
`;
...
export const Placeholder = styled.div`
  ...
  letter-spacing: 1px;
  opacity: 0.5;
  padding: ${({ justifyContent = 'flex-start' }) => justifyContent === 'flex-start' ? '0 20px 0 51px' : '0 20px'};
  pointer-events: none;
  position: absolute;
  top: 0;
  user-select: none;

 ...
 */
export const getSections = factoryService(
  (params) => getJsonRequest(`${API_BASE_URL}/sections${formatParams(params)}`),
);
 ...
 */
export const getSection = factoryService(sectionId => getJsonRequest(`${API_BASE_URL}/sections/${sectionId}`));

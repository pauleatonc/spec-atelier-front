...
export const getUsers = (params) => async (dispatch) => {
  try {
    ...
    if (response?.status >= 400)
      dispatch(onActionCreator(GET_USERS_TO_ACT_AS_ERROR, { loading: false }));
    dispatch(
      onActionCreator(GET_USERS_TO_ACT_AS, {
    ...
    dispatch(
      onActionCreator(GET_USERS_TO_ACT_AS_ERROR, { loading: false, error }),
    );
  }
};

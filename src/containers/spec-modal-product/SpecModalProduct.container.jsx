          ...
          <Section>
            <ImagesContainer>
              {!!product?.images?.length && product.images.map((img, i) =>
                ...
                >
                  <Image src={img?.urls?.medium || img?.urls?.original} type="responsive" height="80px" maxWidth="100%" objectFit="contains"/>
                </ImagesContent>
              )}
            </ImagesContainer>
            {/* Image primary */}
            <ProductImageSelectedContainer>
              <ProductImageSelected>
                <Image src={selectedImg?.urls?.medium || selectedImg?.urls?.original} type="responsive"  height="240px" objectFit="contains" />
              </ProductImageSelected>
            </ProductImageSelectedContainer>
            {/* Info Product */}
            <InfoContainer>
              <InfoContent>
                ...
                <Actions>
                  ...
                  <DownloadDocumentsIcons pdfs={product?.pdfs} dwg={product?.dwg} bim={product?.bim} isDetail productId={product.id}/>
                </Actions>
              </InfoContent>
            </InfoContainer>
          </Section>

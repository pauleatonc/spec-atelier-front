...
import { onHideSpecAdmin, onShowSpecAdminn } from '../spec-admin/SpecAdmin.actions';
...
const SpecNavigator = () => {
	...
	const handleContentsClick = () => {
		if (showContents) { return dispatch(onHideSpecContents()) };
		return (() => {
	...
	const handleAdminClick = () => {
		if (showAdmin) { return dispatch(onHideSpecAdmin()) };
		return (() => {

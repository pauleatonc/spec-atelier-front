...
const RecoverPassword = () => {
  ...
  return (
    <Container>
      ...
      <LoginTitle>¿Se te olvidó tu contraseña?</LoginTitle>
      <TextContent>
        <TextInfo size={14}>
          Ingrese la dirección de correo electrónico que utilizó cuando se unió
      ...
      <form autoComplete="off">
        ...
        <ButtonContainer>
          <Button variant="secondary" onClick={handleSubmit}>
            <ButtonText>Enviar Instrucciones</ButtonText>
          </Button>
        </ButtonContainer>
      </form>
    </Container>

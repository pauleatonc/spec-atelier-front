...
import { SPEC_DOCUMENT, SPEC_TABLE, SPEC_HISTORY } from '../../config/constants/button-variants';
import {
...
const SpecContentButtons = () => {
	...
	return (
		<ContentButton isTypeTable={option === 'T'}>
			<AddIcon
				alt='Listar archivo'
				src={option === SPEC_DOCUMENT ? SPEC_PAGE_SOURCE_SELECTED : SPEC_PAGE_SOURCE}
				onClick={() => handdleShowTable(SPEC_DOCUMENT)}
			/>
			<AddIcon
				alt='Listar tabla'
				src={option === SPEC_TABLE ? SPEC_ADD_SOURCE_W_SELECTED : SPEC_ADD_SOURCE_W}

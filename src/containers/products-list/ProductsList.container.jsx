...
import ProductsSearchContainer from 'containers/search/Search.container';
...
import { getProduct } from 'containers/spec-modal-product/SpecModalProduct.actions';
import ProductCard from 'components/cards/ProductCard';
import DropdownMenu from 'components/menus/DropdownMenu';
import { DEFAULT_FILTER_KEYS, FILTER_OPTIONS } from 'config/constants/products';
import {
  Container,
  ListContainer,
  Separator,
...
const ProductList = ({
  ...
  const onClickFilter = () => setShowMobileFilter((current) => !current);
